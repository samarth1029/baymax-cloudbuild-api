...
if __name__ == "__main__":
    # _query = "SELECT * FROM `stryze-bigquery.test_anton.order_items_xml` LIMIT 1000"
    _query = """UPDATE `stryze-bigquery.test_anton.amz_reports_creation_history`
    SET report_status_ = 'DONE'

    WHERE report_type = 'GET_XML_ALL_ORDERS_DATA_BY_LAST_UPDATE_GENERAL'
    AND company = 'STR'
    AND report_id = '864156019290';
"""
